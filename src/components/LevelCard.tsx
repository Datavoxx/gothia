  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:bg-level-card-hover hover:border-primary/50",
    ...
    >
      ...
      <span className="relative text-2xl font-semibold text-foreground group-hover:text-primary transition-colors duration-300">
        {title}
      </span>
